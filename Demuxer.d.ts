...
export interface DemuxerSeekOptions{
	 ...
	 * Use in conjunction with property:
	 * @property DemuxerSeekOptions.frame
	 * 	or
	 * @property DemuxerSeekOptions.timestamp
	 */
	stream_index?:number
	 ...
	 * @property DemuxerSeekOptions.stream_index
	 */
	frame?:number
